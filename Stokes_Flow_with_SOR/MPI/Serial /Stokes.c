...
void residualU(double* resU,double* U,double* P , int N_row, int N_col, double mu, double dx, double P_const,int color);
void residualV(double* resV,double* V,double* P , int N_row, int N_col, double mu, double dx, double P_const, int color);
void residualP(double* resP, double* U, double* V, double* P , int N_row, int N_col, double mu, double dx, double P_const, int color);
...
//printf("color is red \n");
residualU( resU, u, p , N-1, N, mu, dx, P_const, color);
updateRule(u,resU ,0, N ,N-1, N,  omega,  color);

//printf("u \n" );
//printMat(u,N-1,N);

residualV( resV, v, p , N, N-1, mu, dx, P_const, color);
updateRule(v,resV ,0, N-1 ,N , N-1,  omega,  color);
...
updateRule(p,resP ,0, N-1 ,N-1 , N-1,  omega,  color);
